...
public class FormServiceTest {
	...
	private Deployment deployProcess() {
		...
		Deployment deployment = repositoryService.createDeployment().addClasspathResource("loanrequest_v1.bpmn20.xml").deploy();
	...
	public void startFromSubmit() {
		...
		ProcessDefinition definition = activitiRule.getRepositoryService()
				.createProcessDefinitionQuery().processDefinitionKey("loanrequest_v1").latestVersion().singleResult();
